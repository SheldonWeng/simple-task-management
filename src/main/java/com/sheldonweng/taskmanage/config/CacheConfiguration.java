package com.sheldonweng.taskmanage.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.sheldonweng.taskmanage.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.sheldonweng.taskmanage.repository.UserRepository.USERS_BY_EMAIL_CACHE);
