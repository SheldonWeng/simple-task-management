...
describe('Service Tests', () => {
  describe('Task Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Task(0, 0, 'AAAAAAA', TaskStatus.TODO, 'AAAAAAA', currentDate, currentDate, currentDate);
    });
        ...
        const returnedFromService = Object.assign(
          {
            ...
            planStartTime: currentDate.format(DATE_TIME_FORMAT),
            planEndTime: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
